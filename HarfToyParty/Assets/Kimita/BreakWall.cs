...
public class BreakWall : MonoBehaviour
{
    ...
    //            if (XY.y - mov2.y > 6 || XY.y - mov2.y < 0) return false;
    //            if (map[(int)XY.y - (int)mov2.y, (int)XY.x + x + (int)mov2.x] == (int)MapKind.Wall || map[(int)XY.y - (int)mov2.y, (int)XY.x + x + (int)mov2.x] == (int)MapKind.Player2 || map[(int)XY.y - (int)mov2.y, (int)XY.x + x + (int)mov2.x] == (int)MapKind.Player1 || map[(int)XY.y - (int)mov2.y, (int)XY.x + x + (int)mov2.x] == (int)MapKind.Bomb || (map[(int)XY.y + y - (int)mov2.y, (int)XY.x + x + (int)mov2.x] >= (int)MapKind.Movewall0 && map[(int)XY.y + y - (int)mov2.y, (int)XY.x + x + (int)mov2.x] != (int)MyWallP)) return false;
    //            x = 1;
    //            if (map[(int)XY.y - (int)mov2.y, (int)XY.x + x + (int)mov2.x] == (int)MapKind.Wall || map[(int)XY.y - (int)mov2.y, (int)XY.x + x + (int)mov2.x] == (int)MapKind.Player2 || map[(int)XY.y - (int)mov2.y, (int)XY.x + x + (int)mov2.x] == (int)MapKind.Player2 || map[(int)XY.y - (int)mov2.y, (int)XY.x + x + (int)mov2.x] == (int)MapKind.Bomb || (map[(int)XY.y + y - (int)mov2.y, (int)XY.x + x + (int)mov2.x] >= (int)MapKind.Movewall0 && map[(int)XY.y + y - (int)mov2.y, (int)XY.x + x + (int)mov2.x] != (int)MyWallP)) return false;
    //            break;
    //        case 2:
    ...
    //            x = -1; y = 0;
    //            if (map[(int)XY.y + y - (int)mov2.y, (int)XY.x + x + (int)mov2.x] == (int)MapKind.Wall || map[(int)XY.y + y - (int)mov2.y, (int)XY.x + x + (int)mov2.x] == (int)MapKind.Player2 || map[(int)XY.y + y - (int)mov2.y, (int)XY.x + x + (int)mov2.x] == (int)MapKind.Player1 || map[(int)XY.y + y - (int)mov2.y, (int)XY.x + x + (int)mov2.x] == (int)MapKind.Bomb || (map[(int)XY.y + y - (int)mov2.y, (int)XY.x + x + (int)mov2.x] >= (int)MapKind.Movewall0 && map[(int)XY.y + y - (int)mov2.y, (int)XY.x + x + (int)mov2.x] != (int)MyWallP)) return false;
    //            x = 1; y = 0;
    //            if (map[(int)XY.y + y - (int)mov2.y, (int)XY.x + x + (int)mov2.x] == (int)MapKind.Wall || map[(int)XY.y + y - (int)mov2.y, (int)XY.x + x + (int)mov2.x] == (int)MapKind.Player2 || map[(int)XY.y + y - (int)mov2.y, (int)XY.x + x + (int)mov2.x] == (int)MapKind.Player1 || map[(int)XY.y + y - (int)mov2.y, (int)XY.x + x + (int)mov2.x] == (int)MapKind.Bomb || (map[(int)XY.y + y - (int)mov2.y, (int)XY.x + x + (int)mov2.x] >= (int)MapKind.Movewall0 && map[(int)XY.y + y - (int)mov2.y, (int)XY.x + x + (int)mov2.x] != (int)MyWallP)) return false;
    //            x = 0; y = -1;
    //            if (map[(int)XY.y + y - (int)mov2.y, (int)XY.x + x + (int)mov2.x] == (int)MapKind.Wall || map[(int)XY.y + y - (int)mov2.y, (int)XY.x + x + (int)mov2.x] == (int)MapKind.Player2 || map[(int)XY.y + y - (int)mov2.y, (int)XY.x + x + (int)mov2.x] == (int)MapKind.Player1 || map[(int)XY.y + y - (int)mov2.y, (int)XY.x + x + (int)mov2.x] == (int)MapKind.Bomb || (map[(int)XY.y + y - (int)mov2.y, (int)XY.x + x + (int)mov2.x] >= (int)MapKind.Movewall0 && map[(int)XY.y + y - (int)mov2.y, (int)XY.x + x + (int)mov2.x] != (int)MyWallP)) return false;
    ...
    //            Map.instance.mapInt[y - (int)vec2.y, x + (int)vec2.x] = (int)MyWallP;
    //            break;
    //        case 1:
    //            Map.instance.mapInt[y, x] = 0;
    //            Map.instance.mapInt[y, x + 1] = 0;
    //            Map.instance.mapInt[y - (int)vec2.y, x + (int)vec2.x] = (int)MyWallP;
    //            Map.instance.mapInt[y - (int)vec2.y, x + 1 + (int)vec2.x] = (int)MyWallP;
    //            break;
    //        case 2:
    //            Map.instance.mapInt[y, x] = 0;
    ...
    //            Map.instance.mapInt[y, x - 1] = 0;
    //            Map.instance.mapInt[y - (int)vec2.y, x + (int)vec2.x] = (int)MyWallP;
    //            Map.instance.mapInt[y - (int)vec2.y + 1, x + (int)vec2.x] = (int)MyWallP;
    //            Map.instance.mapInt[y - (int)vec2.y - 1, x + (int)vec2.x] = (int)MyWallP;
    //            Map.instance.mapInt[y - (int)vec2.y, x + (int)vec2.x + 1] = (int)MyWallP;
    //            Map.instance.mapInt[y - (int)vec2.y, x + (int)vec2.x - 1] = (int)MyWallP;
    //            break;
    //        case 3:
    //            Map.instance.mapInt[y, x] = 0;
    //            Map.instance.mapInt[y + 1, x] = 0;
    //            Map.instance.mapInt[y - (int)vec2.y, x + (int)vec2.x] = (int)MyWallP;
    //            Map.instance.mapInt[y + 1 - (int)vec2.y, x + (int)vec2.x] = (int)MyWallP;
    //            break;
    //    }
    //    while (wait >= 0)
    //    {
